				...
				switch (m.group().toLowerCase()) {
			    		...
			    		case "interest": {
			                ...
			                CarouselTemplate carouselTemplate = new CarouselTemplate(
			                        Arrays.asList(
			                                new CarouselColumn(imageUrl, "Categories 1", "Please choose all your interests and type done if you finish.", Arrays.asList(
			                                ...
			                                new CarouselColumn(imageUrl, "Categories 2", "Please choose all your interests and type done if you finish.", Arrays.asList(
			                                ...
			                                new CarouselColumn(imageUrl, "Categories 3", "Please choose all your interests and type done if you finish.", Arrays.asList(
			                                ...
			                                new CarouselColumn(imageUrl, "Categories 4", "Please choose all your interests and type done if you finish.", Arrays.asList(
			                                ...
			                                new CarouselColumn(imageUrl, "Categories 5", "Please choose all your interests and type done if you finish.", Arrays.asList(
